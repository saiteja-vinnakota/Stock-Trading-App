...
function AllOrders() {
  ...
  const filteredOrders = useMemo(() => {
    return orders.filter((order) => {
      ...
      return (
        ...
        order.stock?.symbol?.toLowerCase().includes(keyword)
      );
    });
  }, [orders, search]);
  ...
  const buyOrders = orders.filter((order) => order.orderType === "BUY").length;
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="rounded-3xl bg-linear-to-r from-slate-900 via-slate-800 to-orange-600 text-white p-10 shadow-xl">
            ...
            <p className="mt-3 text-slate-200 text-lg">
              Monitor every BUY and SELL order placed across the platform.
            </p>
          </div>
                  ...
                  {filteredOrders.length === 0 ? (
                    ...
                    filteredOrders.map((order) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <div>
                            <p className="font-bold">{order.stock?.symbol}</p>
